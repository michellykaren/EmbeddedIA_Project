...
#ifndef AI_SMALL_MODEL_H
#define AI_SMALL_MODEL_H
#pragma once

#include "small_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SMALL_MODEL_MODEL_NAME          "small_model"
#define AI_SMALL_MODEL_ORIGIN_MODEL_NAME   "model_small_b32"

/******************************************************************************/
#define AI_SMALL_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SMALL_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SMALL_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SMALL_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_SMALL_MODEL_IN \
  ai_small_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SMALL_MODEL_IN_SIZE { \
  AI_SMALL_MODEL_IN_1_SIZE, \
}
#define AI_SMALL_MODEL_IN_SIZE_BYTES { \
  AI_SMALL_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_SMALL_MODEL_IN_1_HEIGHT      (80)
#define AI_SMALL_MODEL_IN_1_WIDTH       (45)
#define AI_SMALL_MODEL_IN_1_CHANNEL     (3)
#define AI_SMALL_MODEL_IN_1_SIZE        (80 * 45 * 3)
#define AI_SMALL_MODEL_IN_1_SIZE_BYTES  (43200)

/******************************************************************************/
#define AI_SMALL_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SMALL_MODEL_OUT \
  ai_small_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SMALL_MODEL_OUT_SIZE { \
  AI_SMALL_MODEL_OUT_1_SIZE, \
}
#define AI_SMALL_MODEL_OUT_SIZE_BYTES { \
  AI_SMALL_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_SMALL_MODEL_OUT_1_CHANNEL     (2)
#define AI_SMALL_MODEL_OUT_1_SIZE        (2)
#define AI_SMALL_MODEL_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_SMALL_MODEL_N_NODES (9)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup small_model
 ...
 * @ref ai_small_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_small_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_small_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_small_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SMALL_MODEL_*
 * defines into file @ref small_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_small_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SMALL_MODEL_H */
